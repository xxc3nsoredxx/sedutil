...
[ -f scratch/buildroot/output/target/sbin/linuxpba ]                    || die
[ -f scratch/buildroot/output/target/sbin/sedutil-cli ]                 || die
...
pushd $BUILDTYPE &> /dev/null
    ...
    cp -v ../scratch/buildroot/output/images/rootfs.cpio.xz system/EFI/boot/
