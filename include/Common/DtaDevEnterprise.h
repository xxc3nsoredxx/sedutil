...
public:
     ...
     */
    uint8_t getTable (std::vector<uint8_t> table, const char *startcol,
        const char *endcol);
     ...
     */
    uint8_t setTable (std::vector<uint8_t> table, const char *name,
    ...
    uint8_t setLockingRange (uint8_t lockingrange, uint8_t lockingstate, char *password);
    /** dummy code not implemented in the enterprise SSC*/
     ...
     */
    uint8_t rawCmd (char *sp, char *hexauth, char *pass, char *hexinvokingUID,
