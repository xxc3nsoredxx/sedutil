...
public:
     ...
     */
    virtual uint8_t setup_SUM (uint8_t lockingrange, uint64_t start,
        uint64_t length, char *Admin1Password, char *password) = 0;
     ...
     */
    virtual uint8_t objDump (char *sp, char *auth, char *pass, char *objID) = 0;
     ...
     */
    virtual uint8_t rawCmd (char *sp, char *auth, char *pass, char *invoker,
        char *method, char *plist) = 0;
    /** Read MSID
     */
